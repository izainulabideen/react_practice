...
function App() {
  const backgroundImage =
    "https://cdn.corporatefinanceinstitute.com/assets/foreign-exchange-risk.jpeg";
  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="w-full max-w-md m-auto border border-gray-600 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              convert();
